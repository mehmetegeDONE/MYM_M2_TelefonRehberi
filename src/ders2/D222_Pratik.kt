...
fun main() {
    ...
    uygulamaGirisi("Gürkay")
    uygulamaGirisi("Ömer","Web")

}

fun uygulamaGirisi(kullaniciAdi: String, cihazTipi: String = "Mobil"){
    println("Hoşgeldin $kullaniciAdi! ($cihazTipi üzerinden bağlanıldı)")
}